...
- change all css and transform to tailwind framework
- ad edit profile
- add settings
- (partly ) replace svg and pngs icons with https://lucide.dev/icons/ (specialy in auth)
- (parttly done, only clean code )MAKE AUTH PAGE WORK!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! (AND CLEAN CODE BC ITS SO SHIT)
- (DONE)- add edit profile, logout button in navbar
- (DONE) add that login is constant and is not logout after refreshing website
- add md and xl authpage
